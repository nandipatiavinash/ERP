    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2">
          <Card>
            <CardHeader>
              <CardTitle className="text-base">Fabric Rolls Consumed in Lamination</CardTitle>
            </CardHeader>
            <CardContent>
      ...
      {/* SECTION C: Film Rolls (Metallic) Consumption */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-1">
          {isToday && (
            <Card>
        ...
        <div className="lg:col-span-2">
          <Card>
            <CardHeader>
              <CardTitle className="text-base">Metallic Film Rolls Consumed</CardTitle>
            </CardHeader>
            <CardContent>
