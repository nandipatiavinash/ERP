...
export const modules: Record<string, ModuleConfig> = {
  ...
  "raw-materials": {
    ...
    fields: [
      ...
      { name: "opening_stock", label: "Opening Stock (unit)", type: "number", step: "0.001", required: true },
      { name: "current_stock", label: "Current Stock (unit)", type: "number", step: "0.001", required: true },
      { name: "status", label: "Status", type: "select", options: statusOptions, required: true },
    ],
    columns: [
